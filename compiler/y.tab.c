...
{
       0,    60,    60,    63,    65,    68,    71,    73,    76,    79,
      81,    84,    87,    89,    92,    95,    97,   100,   103,   105,
     108,   110,   113,   116,   118,   120,   123,   125,   128,   130,
     132,   134,   137,   139,   142,   144,   147,   150,   152,   155,
     158,   161,   164,   167,   169,   171,   173,   175,   177,   179,
     181,   183,   185,   187,   189,   191,   193,   196,   199,   201,
     204,   206,   208,   210,   212,   214,   216,   219,   221,   224,
     226,   229,   232
};
#endif
...
{
      11,     6,    31,    13,   -28,   -28,   -28,     4,    28,    13,
       5,   -28,   -28,   -28,    14,     4,    26,    28,   -28,   -28,
      32,    46,    27,     5,    47,    49,     5,    52,    52,    45,
      26,    55,   -28,   -28,    51,   -28,   -28,   -28,   -28,   -28,
     -11,   -28,   -28,     5,   -28,    59,    63,    52,    52,   -28,
      52,    52,    52,   -28,   -28,   -28,   153,   -28,   -28,   -28,
      29,   153,   -28,   -28,   -28,    52,    52,    52,   -28,   -28,
       4,   125,   137,   106,    65,    -4,   -28,    52,    52,    52,
      52,    52,    52,    52,   153,   147,   153,     5,    66,    70,
      60,    72,   -28,    52,    52,    52,   -28,    52,    52,   -28,
      -4,    -4,   -28,   -28,   -28,    -4,    25,    68,   -28,   -28,
      73,     4,   -28,    26,    26,   153,   153,   153,   153,   153,
      52,   -28,   -28,    13,    70,    74,    75,    25,   -28,    26,
     -28,    85,   -28,   -28,    79,    81,   -28,    26,    84,   -28
};
...
static const yytype_int8 yydefact[] =
{
      ...
      24,     0,    27,    28,     0,    32,    33,    29,    30,    31,
       ...
       0,     0,     0,    69,    70,    55,    41,    52,    67,    68,
      51,    42,     2,    25,    26,     0,     0,     0,    13,    11,
      18,     0,     0,     0,     0,    47,    50,     0,     0,     0,
       0,     0,     0,    58,    35,     0,    34,     0,     0,    20,
       0,     0,    53,     0,     0,     0,    64,     0,     0,    54,
      43,    44,    45,    46,    48,    49,    60,     0,    36,    21,
       0,     0,    17,     0,     0,    61,    62,    63,    65,    66,
       0,    57,    56,    23,    20,     0,     0,    60,    22,     0,
      19,    37,    39,    59,     0,     0,    16,     0,     0,    38
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -28,   -28,    -7,   -28,   -28,   -28,    -3,   -28,   -13,    89,
     -28,   -28,   -17,    -2,   -28,   -27,   -28,   -28,   -28,   -28,
     -15,   -28,   -28,   -28,   -28,   -28,   -23,   -28,   -16,   -28,
     -28,   -28,    90,   -10
};
...
static const yytype_int16 yydefgoto[] =
{
      ...
      17,    88,   112,    89,   129,    29,    30,    31,    32,    33,
      55,    35,    36,    37,    38,    39,    56,   107,   121,    74,
      57,    58,    59,    60
};
...
{
      21,    34,    18,    63,    14,    61,    40,    66,     5,     6,
      46,    67,    23,    21,     1,    34,    49,     5,     6,     7,
      40,    79,    80,    81,    71,    72,     3,    73,    75,    76,
      68,     4,    22,    21,    24,    15,    25,    26,    27,    28,
     120,    19,    84,    85,    86,    83,    42,    66,    77,    78,
      79,    80,    81,    82,   100,   101,   102,   103,   104,   105,
     106,    43,    19,    47,    44,    48,    62,    87,    50,    64,
     115,   116,   117,    65,   118,   119,    51,   109,    69,    70,
     113,    52,    99,   110,   111,   122,   125,   126,    19,    44,
      53,    54,   114,   123,   135,   131,   132,   127,    34,    34,
     136,   137,   134,    40,    40,   139,    41,   130,    87,   124,
     138,   133,    45,     0,    34,     0,   128,     0,     0,    40,
       0,     0,    34,    92,     0,     0,     0,    40,     0,    77,
      78,    79,    80,    81,    82,     0,    93,    94,    95,    96,
      97,    98,    90,     0,     0,     0,     0,     0,    77,    78,
      79,    80,    81,    82,    91,     0,     0,     0,     0,     0,
      77,    78,    79,    80,    81,    82,   108,     0,     0,     0,
...
{
      10,    16,     9,    30,     7,    28,    16,    18,     4,     5,
      23,    22,    15,    23,     3,    30,    26,     4,     5,     6,
      30,    25,    26,    27,    47,    48,    20,    50,    51,    52,
      43,     0,    18,    43,     8,     7,    10,    11,    12,    13,
      15,    36,    65,    66,    67,    16,    14,    18,    23,    24,
      25,    26,    27,    28,    77,    78,    79,    80,    81,    82,
      83,    15,    36,    16,    37,    16,    21,    70,    16,    14,
      93,    94,    95,    22,    97,    98,    24,    87,    19,    16,
      20,    29,    17,    17,    14,    17,   113,   114,    36,    37,
      38,    39,    20,    20,     9,    21,    21,   120,   113,   114,
      21,    20,   129,   113,   114,    21,    17,   124,   111,   111,
     137,   127,    22,    -1,   129,    -1,   123,    -1,    -1,   129,
      -1,    -1,   137,    17,    -1,    -1,    -1,   137,    -1,    23,
      24,    25,    26,    27,    28,    -1,    30,    31,    32,    33,
      34,    35,    17,    -1,    -1,    -1,    -1,    -1,    23,    24,
      25,    26,    27,    28,    17,    -1,    -1,    -1,    -1,    -1,
      23,    24,    25,    26,    27,    28,    19,    -1,    -1,    -1,
...
static const yytype_int8 yystos[] =
{
      ...
      45,    46,    47,    48,    47,     7,    50,    51,    43,    36,
      49,    74,    18,    47,     8,    10,    11,    12,    13,    56,
      57,    58,    59,    60,    61,    62,    63,    64,    65,    66,
      74,    50,    14,    15,    37,    73,    49,    16,    16,    74,
      16,    24,    29,    38,    39,    61,    67,    71,    72,    73,
      74,    67,    21,    56,    14,    22,    18,    22,    49,    19,
      16,    67,    67,    67,    70,    67,    67,    23,    24,    25,
      26,    27,    28,    16,    67,    67,    67,    47,    52,    54,
      17,    17,    17,    30,    31,    32,    33,    34,    35,    17,
      67,    67,    67,    67,    67,    67,    67,    68,    19,    74,
      17,    14,    53,    20,    20,    67,    67,    67,    67,    67,
      15,    69,    17,    20,    54,    56,    56,    67,    43,    55,
      53,    21,    21,    69,    56,     9,    21,    20,    56,    21
};
...
#line 1734 "y.tab.c"
  ...
  case 43:
#line 168 "alfa.y"
                            {fprintf(yyout, ";R72:\t<exp> ::= <exp> + <exp>\n"); sumar(yyout, yyvsp[-2], yyvsp[0]);}
#line 1740 "y.tab.c"
    break;

  case 44:
#line 170 "alfa.y"
                            {fprintf(yyout, ";R73:\t<exp> ::= <exp> - <exp>\n"); restar(yyout, yyvsp[-2], yyvsp[0]);}
#line 1746 "y.tab.c"
    break;

  case 45:
#line 172 "alfa.y"
                            {fprintf(yyout, ";R74:\t<exp> ::= <exp> / <exp>\n"); dividir(yyout, yyvsp[-2], yyvsp[0]);}
#line 1752 "y.tab.c"
    break;

  case 46:
#line 174 "alfa.y"
                            {fprintf(yyout, ";R75:\t<exp> ::= <exp> * <exp>\n"); multiplicar(yyout, yyvsp[-2], yyvsp[0]);}
#line 1758 "y.tab.c"
    break;

  case 47:
#line 176 "alfa.y"
                            {fprintf(yyout, ";R76:\t<exp> ::= - <exp>\n"); cambiar_signo(yyout, yyvsp[0]);}
#line 1764 "y.tab.c"
    break;

  case 48:
#line 178 "alfa.y"
                            {fprintf(yyout, ";R77:\t<exp> ::= <exp> && <exp>\n"); y(yyput, yyvsp[-2], yyvsp[0]);}
#line 1770 "y.tab.c"
    break;

  case 49:
#line 180 "alfa.y"
                            {fprintf(yyout, ";R78:\t<exp> ::= <exp> || <exp>\n"); o(yyout, yyvsp[-2], yyvsp[0]);}
#line 1776 "y.tab.c"
    break;
